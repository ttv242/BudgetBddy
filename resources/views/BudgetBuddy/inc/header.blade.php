      ...
      <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                        ...
                        <div class="app-navbar flex-shrink-0">
                                                ...
                                                <div class="scroll-y mh-200px mh-lg-350px">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="{{ asset('BudgetBuddy/media/avatars/300-6.jpg') }}"
                                                                alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="{{ asset('BudgetBuddy/media/avatars/300-9.jpg') }}"
                                                                alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="{{ asset('BudgetBuddy/media/avatars/300-11.jpg') }}"
                                                                alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="{{ asset('BudgetBuddy/media/svg/brand-logos/volicity-9.svg') }}"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="{{ asset('BudgetBuddy/media/svg/brand-logos/tvit.svg') }}"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="{{ asset('BudgetBuddy/media/svg/misc/infography.svg') }}"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="{{ asset('BudgetBuddy/media/svg/brand-logos/leaf.svg') }}"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="{{ asset('BudgetBuddy/media/svg/brand-logos/tower.svg') }}"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                            ...
                                            <div class="d-flex flex-column px-9">
                                                ...
                                                <div class="text-center px-4">
                                                    <img class="mw-100 mh-200px" alt="image"
                                                        src="{{ asset('BudgetBuddy/media/illustrations/dozzy-1/1.png') }}" />
                                                </div>
                                                <!--end::Illustration-->
                                            </div>
                                            <!--end::Wrapper-->
                            ...
                            <div class="app-navbar-item ms-1 ms-md-2">
                                ...
                                <div class="btn btn-icon btn-custom btn-color-gray-600 btn-icon-gray-700 btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    <i class="ki-duotone ki-notification-status fs-1"><span
                                            class="path1"></span><span class="path2"></span><span
            ...
            <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                ...
                <!--begin::Toolbar-->
                @include('BudgetBuddy.inc.toolbar')
                <!--end::Toolbar-->
