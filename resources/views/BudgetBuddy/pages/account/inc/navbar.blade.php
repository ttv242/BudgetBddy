        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src="{{ asset('BudgetBuddy/uploads/avatar_img/' . $user->avatar_img) }}" alt="image" />
                    <div
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            @else
                                <a href="#" class="btn btn-sm btn-light-danger fw-bold ms-2 fs-8 py-1 px-3"
                                    data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan"
                                    data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">
                                    Biệt danh
                                </a>
                        ...
                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                            ...
                            @else
                                <a href="#"
                                    class="d-flex align-items-center text-gray-400 text-hover-danger me-5 mb-2">
                                    <i class="ki-duotone ki-profile-circle fs-4 me-1"><span class="path1"></span><span
                                            class="path2"></span><span class="path3"></span></i>
                                    Nghề nghiệp
                                </a>
                    ...
                    <div class="d-flex my-4">
                        ...
                        <a href="#" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_offer_a_deal">Thuê tôi</a>
