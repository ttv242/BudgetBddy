    ...
    <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content ">
                ...
                <!--begin::Content menu-->
                <div
                    class="app-content-menu menu menu-rounded flex-wrap fs-5 fw-bold border-bottom mt-n7 pt-5 pb-6 px-10 mb-10">
                    <!--begin::Menu item-->
                    <div class="menu-item pe-2">
                        <a class="menu-link px-5 active" href="/axel-html-pro/index.html">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item pe-2">
                        <a class="menu-link px-5 " href="/axel-html-pro/apps/projects/list.html">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item pe-2">
                        <a class="menu-link px-5 " href="/axel-html-pro/apps/user-management/users/list.html">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item pe-2">
                        <a class="menu-link px-5 " href="/axel-html-pro/apps/subscriptions/list.html">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item pe-2">
                        <a class="menu-link px-5 " href="/axel-html-pro/apps/customers/list.html">
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item pe-2">
                        <a class="menu-link px-5 " href="/axel-html-pro/apps/ecommerce/catalog/products.html">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-400">Organic
                                        Sessions</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ asset('BudgetBuddy/media/svg/brand-logos/dribbble-icon-1.svg') }}"
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ asset('BudgetBuddy/media/svg/brand-logos/linkedin-1.svg') }}"
                                        class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ asset('BudgetBuddy/media/svg/brand-logos/slack-icon.svg') }}"
                                        class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ asset('BudgetBuddy/media/svg/brand-logos/youtube-3.svg') }}"
                                        class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                                ...
                                <div class="d-flex flex-stack">
                                    <!--begin::Flag-->
                                    <img src="{{ asset('BudgetBuddy/media/svg/brand-logos/instagram-2-1.svg') }}"
                                        class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                    <!--end::Flag-->
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4">
                                        ...
                                        <thead>
                                            <tr class="fs-7 fw-bold border-0 text-gray-400">
                                                <th class="min-w-200px" colspan="2">LANDING PAGE
                                                </th>
                    ...
                    <div class="col-xl-6 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <div class="card-toolbar">
                                    <div class="card-toolbar">
                                        <a href="#" class="btn btn-sm btn-light">PDF
                                            Report</a>
                                    </div>
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-400">Avarage
                                        Position</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                            ...
                            <div class="card-body d-flex align-items-end">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-30px me-5">
                                            <span class="symbol-label">
                                                <i class="ki-duotone ki-rocket fs-3 text-gray-600"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-30px me-5">
                                            <span class="symbol-label">
                                                <i class="ki-duotone ki-abstract-39 fs-3 text-gray-600"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                    ...
                    <div class="col-xl-4 mb-5 mb-xl-0">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7 mb-7">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="/axel-html-pro/apps/ecommerce/catalog/add-product.html"
