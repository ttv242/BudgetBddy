                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="radio" class="btn-check"
                                                    name="account_type" value="personal"
                                                    checked="checked"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <label
                                                    ...
                                                    <span class="d-block fw-semibold text-start">
                                                        <span
                                                            class="text-dark fw-bold d-block fs-4 mb-2">Corporate
                                                            Account</span>
                                                        <span
                                                            class="text-muted fw-semibold fs-6">Create
                                        ...
                                        <div class="row mb-2" data-kt-buttons="true">
                                            ...
                                            <div class="col">
                                                ...
                                                <label
                                                    ...
                                                    <input type="radio" class="btn-check"
                                                        name="account_team_size" checked
                                                        value="2-10" />
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="symbol symbol-50px me-6">
                                                        <span class="symbol-label">
                                                            <i
                                                                class="ki-duotone ki-bank fs-1 text-gray-600"><span
                                                                    class="path1"></span><span
                                                                    class="path2"></span></i>
                                                        </span>
                                                    </span>
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        <span
                                                            ...
                                                            Account</span>
                                                        <span
                                                            class="fs-6 fw-semibold text-muted">Use
                                            ...
                                            <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="symbol symbol-50px me-6">
                                                        <span class="symbol-label">
                                                            <i
                                                                class="ki-duotone ki-chart fs-1 text-gray-600"><span
                                                                    class="path1"></span><span
                                                                    class="path2"></span></i>
                                                        </span>
                                                    </span>
                                                ...
                                                <span
                                                    class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio"
                                                        checked name="account_plan" value="2" />
                                                </span>
                                                <!--end:Input-->
                                            </label>
                                            <!--end::Option-->
                                            ...
                                            <label class="d-flex flex-stack mb-0 cursor-pointer">
                                                ...
                                                <span class="d-flex align-items-center me-2">
                                                    ...
                                                    <span class="symbol symbol-50px me-6">
                                                        <span class="symbol-label">
                                                            <i
                                                                class="ki-duotone ki-chart-pie-4 fs-1 text-gray-600"><span
                                                                    class="path1"></span><span
                                                                    class="path2"></span><span
                                                                    class="path3"></span></i>
                                                        </span>
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div
                                            ...
                                            <!--begin::Icon-->
                                            <i
                                                class="ki-duotone ki-information fs-2tx text-warning me-4"><span
                                                    class="path1"></span><span
                                                    class="path2"></span><span
