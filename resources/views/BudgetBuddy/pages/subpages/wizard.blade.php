        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content ">
                ...
                <div class="card">
                        ...
                        <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="d-block fw-semibold text-start">
                                                            ...
                                                            <span class="text-muted fw-semibold fs-6">If
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="d-block fw-semibold text-start">
                                                            <span class="text-dark fw-bold d-block fs-4 mb-2">Corporate
                                                                Account</span>
                                                            <span class="text-muted fw-semibold fs-6">Create
                                                                corporate account to mane users</span>
                                                        </span>
                                                        <!--end::Info-->
                                                    </label>
                                                    <!--end::Option-->
                                                    ...
                                                    <span class="d-flex align-items-center me-2">
                                                        ...
                                                        <span class="d-flex flex-column">
                                                            <span
                                                                ...
                                                                Account</span>
                                                            <span class="fs-6 fw-semibold text-muted">Use
                                                                images to enhance your post flow</span>
                                                        </span>
                                                        <!--end:Description-->
                                                    </span>
                                                    <!--end:Label-->
                            ...
                            ">
                                        ...
                                        <div class="fv-row mb-0">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label required">Contact
                                                Email</label>
                                            <!--end::Label-->
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                    <img src="{{ asset('BudgetBuddy/media/svg/card-logos/visa.svg') }}"
                                                        alt="" class="h-25px" />
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-8 pb-lg-10">
                                            ...
                                            <div class="text-muted fw-semibold fs-6">
                                                ...
                                                <a href="/axel-html-pro/.html" class="link-primary fw-bold">
                                                    Sign In
                                                </a>
                                                .
                                            </div>
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="fs-6 text-gray-600 mb-5">
                                                ...
                                                is a science
                                                and probably warrants its own post, but for all advise
                                                is with what
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-stack flex-grow-1 ">
                                                    ...
                                                    <div class=" fw-semibold">
                                                        ...
                                                        <div class="fs-6 text-gray-700 ">To start using
                                                            great tools, please, <a
                                                                href="/axel-html-pro/utilities/wizards/vertical.html"
                    ...
                    <!--begin::Card body-->
                    <div class="card-body">
                        {{-- <h3 class="text-center">Tài khoản nhóm | Tham gia nhóm</h3>
                        <form action="" class="row d-flex">
                            <!--begin::Input group-->
                            <div class="form-floating mb-7">
                                <input type="text" class="form-control" id="floatingInput" placeholder="Tên nhóm" />
                                <label for="floatingInput">Tên nhóm (Tạo nhóm)</label>
                            </div>
                            <!--end::Input group-->
                            <p class="col-12 text-center">Hoặc</p>
                            <!--begin::Input group-->
                            <div class="form-floating">
                                <input type="text" class="form-control" id="floatingInputValue"
                                    placeholder="ID Nhóm" />
                                <label for="floatingInputValue">ID Nhóm (Tham gia)</label>
                            </div>
                            <!--end::Input group-->
                        </form> --}}
                        <div class="d-flex flex-row-auto justify-content-between">
                            <button type="button" class="col-5 btn btn-primary" data-bs-toggle="modal"
                        ...
                        <div class="modal fade" tabindex="-1" id="kt_modal_1">
                            <div class="modal-dialog">
                                <form class="modal-content" action="{{ route('wizard_') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="text" class="form-control form-control-flush"
                                            placeholder="Nhập tên nhóm" name="name" />
                                        <input type="text" class="form-control form-control-flush"
                                            placeholder="Nhập tên nhóm" name="address" />
                                    </div>
                        ...
                        <div class="modal fade" tabindex="-1" id="kt_modal_2">
                            <div class="modal-dialog">
                                <form class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">Tham gia nhóm</h3>
