                            ...
                            <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                                ...
                                <div class="mt-n1">
                                    ...
                                    <div class="d-flex flex-stack pb-10">
                                        ...
                                        <a href="#">
                                            <img alt="Logo"
                                                src="/axel-html-pro/assets/media/svg/brand-logos/code-lab.svg" />
                                        </a>
                                        <!--end::Logo-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="row g-5 mb-11">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <!--end::Col-->
                                                <div class="fw-bold fs-6 text-gray-800">12 Apr 2021
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-sm-6">
                                                <!--end::Label-->
                                                <div class="fw-semibold fs-7 text-gray-600 mb-1">Due
                                                    Date:</div>
                                                <!--end::Label-->
                                        ...
                                        <div class="row g-5 mb-12">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-gray-800">KeenThemes Inc.
                                                </div>
                                                <!--end::Text-->
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <!--end::Text-->
                                                <div class="fw-bold fs-6 text-gray-800">CodeLab Inc.
                                                </div>
                                                <!--end::Text-->
                                                ...
                                                <table class="table mb-3">
                                                    <thead>
                                                        <tr class="border-bottom fs-6 fw-bold text-muted">
                                                            <th class="min-w-175px pb-2">Description
                                                            </th>
                                                            <th class="min-w-70px text-end pb-2">Hours
                                                            </th>
                                                            <th class="min-w-80px text-end pb-2">Rate
                                                            </th>
                            ...
                            <div class="m-0">
                                ...
                                <div
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="fw-bold text-gray-800 fs-6">codelabpay@codelab.co
                                        </div>
                                    </div>
                                    <!--end::Item-->
