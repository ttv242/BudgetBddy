...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('BudgetBuddy/media/logos/favicon.ico') }}" />
    ...
    <link href="{{ asset('BudgetBuddy/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('BudgetBuddy/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="app-blank">
            ...
            <div class="d-flex flex-column flex-lg-row-auto bg-primary w-xl-600px positon-xl-relative">
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-none d-lg-block d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px"
                        style="background-image: url({{ asset('BudgetBuddy/media/illustrations/dozzy-1/17.png') }})">
                    </div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            data-kt-redirect-url="{{ route('signIn_') }}" action="{{ route('signIn_') }}" method="POST">
                            @csrf
                            <!--begin::Heading-->
                            <div class="text-center mb-10">
                                <!--begin::Title-->
                                <h1 class="text-dark mb-3">
                                    Sign In to Axel HTML Pro </h1>
                                <!--end::Title-->
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="d-flex flex-stack mb-2">
                                    ...
                                    <!--begin::Link-->
                                    <a href="/axel-html-pro/authentication/sign-in/password-reset.html"
                            ...
                            <div class="text-center">
                                ...
                                <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                                    <img alt="Logo"
                                        src="{{ asset('BudgetBuddy/media/svg/brand-logos/google-icon.svg') }}"
                                        class="h-20px me-3" />
                                ...
                                <!--begin::Google link-->
                                <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                                    <img alt="Logo" src="{{ asset('BudgetBuddy/media/svg/brand-logos/facebook-4.svg') }}"
                                        class="h-20px me-3" />
                                ...
                                <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100">
                                    <img alt="Logo"
                                        src="{{ asset('BudgetBuddy/media/svg/brand-logos/apple-black.svg') }}"
                                        class="theme-light-show h-20px me-3" />
                                    <img alt="Logo"
                                        src="{{ asset('BudgetBuddy/media/svg/brand-logos/apple-black-dark.svg') }}"
    ...
    <script src="{{ asset('BudgetBuddy/js/custom/authentication/sign-in/general.js') }}"></script>
