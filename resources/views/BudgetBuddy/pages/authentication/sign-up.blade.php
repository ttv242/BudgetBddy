...
<body id="kt_body" class="app-blank">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-600px p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" novalidate="novalidate"
                            data-kt-redirect-url="{{ route('signUp_') }}"
                            id="kt_sign_up_form" action="{{ route('signUp_') }}" method="POST">
                            @csrf
                            <!--begin::Heading-->
                            ...
                            <div class="row fv-row mb-7">
                                <!--begin::Col-->
                                    ...
                                    <input class="form-control form-control-lg form-control-solid" type="text"
                                        placeholder="" name="full_name" autocomplete="on" />
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input class="form-control form-control-lg form-control-solid" type="email"
                                    placeholder="" name="email" autocomplete="on" />
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input class="form-control form-control-lg form-control-solid" type="text"
                                    placeholder="" name="username" autocomplete="on" />
                            </div>
                            <!--end::Input group-->
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="position-relative mb-3">
                                        <input class="form-control form-control-lg form-control-solid" type="password"
                                            placeholder="" name="password" autocomplete="on" />
                            ...
                            <div class="fv-row mb-5">
                                ...
                                <input class="form-control form-control-lg form-control-solid" type="password"
                                    placeholder="" name="confirm_password" autocomplete="on" />
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="text-center">
                                <button type="submmit" id="" class="btn btn-lg btn-primary">
    ...
    <script src="{{ asset('BudgetBuddy/js/custom/authentication/sign-up/general.js') }}"></script>
