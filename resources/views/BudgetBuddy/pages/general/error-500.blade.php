...
<body id="kt_body" class="app-blank">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div class="d-flex flex-row-fluid flex-column flex-column-fluid text-center p-10 py-lg-20">
                ...
                <a href="/axel-html-pro/index.html" class="pt-lg-20 mb-12">
                    <img alt="Logo" src="/axel-html-pro/assets/media/logos/default.svg"
                        class="theme-light-show h-40px h-lg-50px" />
                    <img alt="Logo" src="/axel-html-pro/assets/media/logos/default-dark.svg"
    ...
    <!--begin::Javascript-->
    <script>
        var hostUrl = "/axel-html-pro/assets/";
    </script>
